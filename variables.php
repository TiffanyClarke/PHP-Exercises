...
//$totalPrice = $price + ($price * $delivery) * $tax;  
$totalPrice = $price + $price * $tax + $price * $delivery;
...
echo "<figure>
        ...
        <figcaption>$product: $totalPrice </figcaption>
    </figure>";
?>