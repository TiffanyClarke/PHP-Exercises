...
if ($redLight && $yellowLight ===true) {
    echo "Stop the car!"; 
} else {echo "Are you sure that traffic lights are working at all?";
}
...
if ($redLight && $yellowLight === true){echo "Stop the car!";
} else if ($redLight && $yellowLight && $greenLight === false){echo "Power outage!";}
    else if ($redLight && $yellowLight === false) {echo "Keep moving!";} else if (
    $redLight && $yellowLight && $greenLight === true) {echo "Traffic lights are messed up!";} 
    else {echo"Use the common sense and stay safe!";}
...
switch (true) {
    case $redLight && $yellowLight === true:
       echo "Stop the car!";
    ...
    case $redLight && $yellowLight && $greenLight === false:
      echo "Power outage!";
      break;  
    case $redLight && $yellowLight === false:
        echo "Keep moving!";
        break;
    case  $redLight && $yellowLight && $greenLight === true:
